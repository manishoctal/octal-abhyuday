    ...
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 pt-4 pb-24">
        <div className="mb-4">
          ...
          <h1 className="text-xl sm:text-2xl font-extrabold text-slate-900 mt-1">🪪 QR Attendance</h1>
          <p className="text-sm text-slate-500 mt-0.5">Scan employee badges at the entrance. Attendance is logged in real time.</p>
        </div>
        <ScanModule />
      </main>
    </>
